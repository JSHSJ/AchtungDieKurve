<script lang="ts">
    import ColorThemeSwitch from '../colorTheme/ColorThemeSwitch.svelte';
...
<section class="screen">
    ...
    <div class="menu">
        ...
        <form class="config-content config-form stack">
            <ColorThemeSwitch />
            ...
            <div class="input-wrapper">
                <label for="options-line-length">
                    ...
                    <span class="input-description">Length of drawn line, before a gap occurs</span
                    ></label
                >
                <input
                    type="number"
            ...
            <div class="input-wrapper">
                <label for="options-credit-killer">
                    ...
                    <span class="input-description"
                        >Add a point to the killer, when a player runs into another players line</span
                    ></label
                >
                <input
                    type="checkbox"
            ...
            <div class="input-wrapper">
                <label for="options-use-ranking">
                    ...
                    <span class="input-description"
                        >Add points based on ranking. First player gets most points, last gets one.</span
                    ></label
                >
                <input
                    type="checkbox"
